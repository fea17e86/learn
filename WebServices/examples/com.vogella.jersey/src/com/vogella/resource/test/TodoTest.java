package com.vogella.resource.test;
...
public class TodoTest {
  ...
  public static void main(String[] args) {
    ...
    Response response = service.path("todos").path(todo.getId()).request(MediaType.APPLICATION_XML).put(Entity.entity(todo,
  ...
  private static URI getBaseURI() {
    return UriBuilder.fromUri("http://localhost:8080/com.vogella.jersey").build();
  }
